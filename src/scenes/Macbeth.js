class Macbeth extends Phaser.Scene {
    ...
    create() {
        ...
        this.first_witch = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'first_witch').setScale(0.75).setOrigin(0, 1);
        this.second_witch = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'second_witch').setScale(0.5).setOrigin(0, 1);
        this.third_witch = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'third_witch').setScale(0.4).setOrigin(0, 1);
